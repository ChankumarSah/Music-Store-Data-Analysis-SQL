...
/* Change the path to your CSV file location */

COPY employee
FROM '/path/employee.csv'
DELIMITER ','
CSV HEADER;
...
COPY playlist
FROM '/path/playlist.csv'
DELIMITER ','
CSV HEADER;

COPY playlist_track
FROM '/path/playlist_track.csv'
DELIMITER ','
CSV HEADER;

COPY invoice
FROM '/path/invoice.csv'
DELIMITER ','
CSV HEADER;

COPY invoice_line
FROM '/path/invoice_line.csv'
DELIMITER ','
CSV HEADER;
